...
const comparator = await text('pocs/telemetry-shadow-comparator/internal/comparison/comparison.go');
const comparatorCLI = await text('pocs/telemetry-shadow-comparator/cmd/telemetry-shadow-comparator/main.go');
...
const files = await sourceFiles(resolve(root, 'pocs/telemetry-shadow-comparator'));
