...
- compact `/assets` hierarchy: no eyebrow, long explanatory subtitle, repeated current-selection copy, or future-interface implementation hint; desktop/tablet page header remains at or below 70px and mobile at or below 92px;
