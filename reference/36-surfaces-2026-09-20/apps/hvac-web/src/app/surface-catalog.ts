...
export const SURFACE_CATALOG = [
  ...
  { id: '05', title: '趋势分析', navLabel: '趋势', group: 'operations', scope: 'site', route: '/sites/:siteId/trends', navigation: 'default', pattern: 'analysis' },
  { id: '06', title: '设备中心', navLabel: '设备', group: 'operations', scope: 'site', route: '/sites/:siteId/devices', navigation: 'default', pattern: 'ledger' },
  ...
  { id: '08', title: '舒适与室内环境', navLabel: '舒适与室内环境', group: 'operations', scope: 'site', route: '/sites/:siteId/comfort', navigation: 'default', pattern: 'analysis' },
  { id: '09', title: '告警中心', navLabel: '告警', group: 'events', scope: 'site', route: '/sites/:siteId/alarms', navigation: 'default', pattern: 'ledger' },
  { id: '10', title: '诊断中心', navLabel: '诊断', group: 'events', scope: 'site', route: '/sites/:siteId/diagnostics', navigation: 'default', pattern: 'ledger' },
  { id: '11', title: '工单中心', navLabel: '工单', group: 'events', scope: 'site', route: '/sites/:siteId/work-orders', navigation: 'default', pattern: 'ledger' },
  ...
  { id: '15', title: '需求、负荷与柔性分析', navLabel: '需求与负荷', group: 'energy', scope: 'site', route: '/sites/:siteId/demand', navigation: 'default', pattern: 'analysis' },
  { id: '16', title: '效率分析', navLabel: '效率', group: 'energy', scope: 'site', route: '/sites/:siteId/efficiency', navigation: 'default', pattern: 'analysis' },
  ...
  { id: '25', title: '控制中心', navLabel: '控制中心', group: 'optimization', scope: 'site', route: '/sites/:siteId/control', navigation: 'default', pattern: 'control' },
  { id: '26', title: '策略中心', navLabel: '策略中心', group: 'optimization', scope: 'site', route: '/sites/:siteId/strategies', navigation: 'default', pattern: 'ledger' },
  ...
  { id: '29', title: '报告中心', navLabel: '报告', group: 'management', scope: 'site', route: '/sites/:siteId/reports', detailRoutes: ['/sites/:siteId/reports/:reportId', '/sites/:siteId/report-definitions/:definitionId'], navigation: 'default', pattern: 'ledger' },
