    ...
    <Main className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary">新鲜</Badge>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="gap-0 py-0">
        <CardHeader className="border-b py-4">
          <CardTitle>扫描型工作区</CardTitle>
          <CardDescription>列表、告警、设备和工单优先使用语义 Table，而不是卡片墙。</CardDescription>
          <CardAction><Badge variant="secondary">3 项</Badge></CardAction>
        </CardHeader>
        <CardContent className="p-0">
          <DataTable
            table={table}
            className="gap-0"
            tableAriaLabel="扫描型工作区示例"
