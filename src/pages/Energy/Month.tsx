...
export default function EnergyMonth() {
  const [searchParams, setSearchParams] = useSearchParams();
  const { navigateGranularity } = useEnergySystemContext();
      ...
      <div className="energy-context-bar energy-month-drilldown-bar" aria-label="月度能耗钻取上下文">
        <div className="energy-context-fields">
          <div className="energy-context-field is-wide">
            <span className="energy-context-label">月度口径</span>
          ...
          <div className="energy-context-field is-wide">
            <span className="energy-context-label">设备类别</span>
            <span className="energy-context-value">{selectedType ? TYPE_LABEL[selectedType] : '全部设备类别'}</span>
          </div>
          <div className="energy-context-field">
        ...
        <div className="energy-context-actions">
          <Select value={selectedDayNumber} options={dayOptions} onChange={(value) => selectDay(value)} aria-label="选择月度钻取日期" />
          <Button
            type="primary"
            onClick={() => navigateGranularity('day', {
              year,
              month,
