...
const ROLE_RULES: Record<Role, PermissionRule[]> = {
  ...
  ops: [
    { actions: ['view'], subjects: ['dashboard', 'assets', 'fdd', 'alarms', 'bigscreen', 'asset', 'diagnosis', 'workOrder'] },
    { actions: ['create'], subjects: ['workOrder'] },
  ...
  rd: [
    {
      actions: ['view'],
      subjects: [
        'dashboard', 'assets', 'energy', 'optimize', 'fdd', 'alarms', 'ai', 'cost', 'bigscreen', 'system',
        'asset', 'diagnosis', 'workOrder', 'optimization', 'costReport', 'systemConfig',
      ],
    },
