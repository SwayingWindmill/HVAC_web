...
var v212ContractOnlyRoutes = []v212ContractOnlyRoute{
	...
	{method: http.MethodGet, template: "/api/v1/alarms"},
	{method: http.MethodGet, template: "/api/v1/alarms/{alarmId}", placeholder: "{alarmId}"},
	{method: http.MethodPost, template: "/api/v1/alarms/{alarmId}/ack", placeholder: "{alarmId}"},
