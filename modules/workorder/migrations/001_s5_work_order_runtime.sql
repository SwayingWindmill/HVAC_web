...
CREATE TABLE IF NOT EXISTS work_order_runtime.work_order_source_reference (
  ...
  created_at timestamptz NOT NULL,
  PRIMARY KEY (tenant_id, site_id, work_order_id, source_domain, source_resource_id),
...
CREATE UNIQUE INDEX IF NOT EXISTS work_order_one_origin_idx
  ON work_order_runtime.work_order_source_reference (tenant_id, site_id, work_order_id)
...
CREATE TABLE IF NOT EXISTS work_order_runtime.work_order_timeline (
  ...
  PRIMARY KEY (tenant_id, site_id, work_order_id, version),
  FOREIGN KEY (tenant_id, site_id, work_order_id)
    REFERENCES work_order_runtime.work_order_current (tenant_id, site_id, work_order_id)
    ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS work_order_runtime.work_order_task (
  ...
  created_at timestamptz NOT NULL,
  updated_at timestamptz NOT NULL CHECK (updated_at >= created_at),
  PRIMARY KEY (tenant_id, site_id, work_order_id, task_id),
  UNIQUE (tenant_id, site_id, work_order_id, position),
  FOREIGN KEY (tenant_id, site_id, work_order_id)
    REFERENCES work_order_runtime.work_order_current (tenant_id, site_id, work_order_id)
    ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS work_order_runtime.work_order_note (
  ...
  created_at timestamptz NOT NULL,
  PRIMARY KEY (tenant_id, site_id, work_order_id, note_id),
  FOREIGN KEY (tenant_id, site_id, work_order_id)
    REFERENCES work_order_runtime.work_order_current (tenant_id, site_id, work_order_id)
    ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS work_order_runtime.work_order_attachment_metadata (
  ...
  created_at timestamptz NOT NULL,
  PRIMARY KEY (tenant_id, site_id, work_order_id, attachment_id),
  FOREIGN KEY (tenant_id, site_id, work_order_id)
    REFERENCES work_order_runtime.work_order_current (tenant_id, site_id, work_order_id)
    ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS work_order_runtime.work_order_completion_evidence (
  ...
  PRIMARY KEY (tenant_id, site_id, work_order_id, kind, reference),
  FOREIGN KEY (tenant_id, site_id, work_order_id)
    REFERENCES work_order_runtime.work_order_current (tenant_id, site_id, work_order_id)
    ON DELETE RESTRICT
);
...
CREATE INDEX IF NOT EXISTS work_order_current_site_updated_idx
  ON work_order_runtime.work_order_current (tenant_id, site_id, updated_at DESC, work_order_id ASC);
CREATE INDEX IF NOT EXISTS work_order_current_site_status_idx
  ON work_order_runtime.work_order_current (tenant_id, site_id, status, updated_at DESC);
CREATE INDEX IF NOT EXISTS work_order_current_site_priority_idx
  ON work_order_runtime.work_order_current (tenant_id, site_id, priority, updated_at DESC);
CREATE INDEX IF NOT EXISTS work_order_current_site_assignee_idx
  ON work_order_runtime.work_order_current (tenant_id, site_id, assignee_id, updated_at DESC)
...
BEGIN
  ...
  LOOP
    ...
    EXECUTE format(
      'CREATE POLICY %I ON work_order_runtime.%I FOR SELECT TO s5_work_order_runtime USING (tenant_id = NULLIF(current_setting(''app.tenant_id'', true), '''')::uuid)',
