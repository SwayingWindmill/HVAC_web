# Legacy Registry migrator

> Historical one-shot migration tool. It is not part of the current runtime, `go.work`, stable S1 unit matrix, or active CI workflow set.
