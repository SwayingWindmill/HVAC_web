...
includesAll(workflow, ['runs-on: ubuntu-24.04', "go-version: '1.25.12'", "node-version: '22.22.0'", 'npm run s2:iam-authorization', 'out/s2-ticket-02/iam-authorization-evidence.json'], 'S2 IAM workflow');
