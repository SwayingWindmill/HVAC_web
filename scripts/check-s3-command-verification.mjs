...
const [plan, ownership, model, service, serviceTests, postgres, postgresTests, migration, worker, workerTests, mqttConnector, mqttEdge, routes] = await Promise.all([
  ...
  read('modules/command/pkg/commandservice/service.go'),
  read('modules/command/pkg/commandservice/service_test.go'),
  read('modules/command/pkg/commandservice/postgres_verification.go'),
  ...
  read('modules/command/pkg/commanddispatcher/verification.go'),
  read('modules/command/pkg/commanddispatcher/verification_test.go'),
  read('modules/command/pkg/mqttconnector/connector.go'),
