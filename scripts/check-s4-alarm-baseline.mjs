...
const [
  ...
  readText('modules/alarm/pkg/alarmservice/http.go'),
  readText('modules/alarm/pkg/alarmservice/store.go'),
  readText('modules/alarm/pkg/alarmservice/postgres.go'),
  readText('modules/alarm/pkg/alarmservice/evaluator.go'),
  readText('modules/alarm/pkg/alarmservice/evaluator_postgres.go'),
  readText('modules/alarm/pkg/alarmservice/evaluator_policy_postgres.go'),
  readText('modules/alarm/migrations/001_s4_alarm_runtime.sql'),
  readText('modules/alarm/migrations/002_s4_alarm_lifecycle.sql'),
  readText('modules/alarm/migrations/005_s13_alarm_orthogonal.sql'),
  readText('modules/alarm/migrations/rollback/005_s13_alarm_orthogonal.sql'),
  readText('modules/alarm/migrations/006_s14_alarm_evaluator.sql'),
  readText('libs/alarmauth/authorization.go'),
  readText('modules/iam/internal/iam/alarm_authorization.go'),
  readText('modules/iam/internal/iam/postgres_alarm_authorization.go'),
  readText('infra/registry/postgres/init/007-s4-alarm-authorization.sql'),
  readText('cmd/energy-api/internal/gateway/alarm.go'),
  readText('cmd/energy-api/internal/gateway/v212_contract_only.go'),
