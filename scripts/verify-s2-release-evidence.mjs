...
if (entries.length < 19) throw new Error('S2 release evidence checksum manifest is incomplete');
...
if (!Array.isArray(statement.subject) || statement.subject.length < 18 || statement.predicate.allSecurityZeroInvariants !== true || statement.predicate.legacyRequestFallback !== false) {
