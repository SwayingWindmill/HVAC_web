...
invariant(schemas.EffectiveAuthorization.properties.capabilities.uniqueItems === true && schemas.EffectiveAuthorization.properties.capabilities.maxItems === 20, 'EffectiveAuthorization capabilities must be unique and bounded');
