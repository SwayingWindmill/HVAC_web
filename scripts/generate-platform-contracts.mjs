...
const expectedOperations = {
  ...
  updateSite: ['patch', '/api/v1/sites/{siteId}'],
  createSiteSpace: ['post', '/api/v1/sites/{siteId}/spaces'],
  updateSiteSpace: ['patch', '/api/v1/sites/{siteId}/spaces/{spaceId}'],
  createSiteAsset: ['post', '/api/v1/sites/{siteId}/assets'],
  updateSiteAsset: ['patch', '/api/v1/sites/{siteId}/assets/{assetId}'],
  createSiteDevice: ['post', '/api/v1/sites/{siteId}/devices'],
  updateSiteDevice: ['patch', '/api/v1/sites/{siteId}/devices/{deviceId}'],
  createSiteSensor: ['post', '/api/v1/sites/{siteId}/sensors'],
  updateSiteSensor: ['patch', '/api/v1/sites/{siteId}/sensors/{sensorId}'],
  createSitePoint: ['post', '/api/v1/sites/{siteId}/points'],
  updateSitePoint: ['patch', '/api/v1/sites/{siteId}/points/{pointId}'],
  rebindRegistryResource: ['post', '/api/v1/sites/{siteId}/bindings/rebind'],
  releaseRegistryTemplateRevision: ['post', '/api/v1/templates/revisions'],
  assignRegistryTemplateRevision: ['post', '/api/v1/templates/assignments'],
  planRegistryImport: ['post', '/api/v1/sites/{siteId}/imports/dry-run'],
  commitRegistryImport: ['post', '/api/v1/sites/{siteId}/imports/commit'],
  beginRegistryRetirement: ['post', '/api/v1/sites/{siteId}/retire'],
...
const replacements = {
  ...
  __SITE_SPACES_PATH__: operations.createSiteSpace.path,
  __SITE_SPACE_PATH__: operations.updateSiteSpace.path,
  __SITE_ASSET_DETAIL_PATH__: operations.updateSiteAsset.path,
  __SITE_DEVICE_DETAIL_PATH__: operations.updateSiteDevice.path,
  __SITE_SENSORS_PATH__: operations.createSiteSensor.path,
  __SITE_SENSOR_PATH__: operations.updateSiteSensor.path,
  __SITE_POINTS_PATH__: operations.createSitePoint.path,
  __SITE_POINT_PATH__: operations.updateSitePoint.path,
  __SITE_REBIND_PATH__: operations.rebindRegistryResource.path,
  __TEMPLATE_REVISIONS_PATH__: operations.releaseRegistryTemplateRevision.path,
  __TEMPLATE_ASSIGNMENTS_PATH__: operations.assignRegistryTemplateRevision.path,
  __SITE_IMPORT_DRY_RUN_PATH__: operations.planRegistryImport.path,
  __SITE_IMPORT_COMMIT_PATH__: operations.commitRegistryImport.path,
  __SITE_RETIRE_PATH__: operations.beginRegistryRetirement.path,
