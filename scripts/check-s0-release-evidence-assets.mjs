...
const ticket = await readFile(resolve(root, 'docs/evidence/go-data-ai-platform-s0/issues/08-s0-release-evidence.md'), 'utf8');
const tracker = await readFile(resolve(root, 'docs/evidence/go-data-ai-platform-s0/README.md'), 'utf8');
