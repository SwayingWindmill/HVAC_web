...
const store = read('modules/iot/internal/connectivity/edge_fleet.go');
const runtimeStore = read('modules/iot/internal/connectivity/edge_fleet_runtime.go');
const syncStore = read('modules/iot/internal/connectivity/edge_fleet_sync.go');
const fleetRuntime = read('modules/iot/internal/fleet/runtime.go');
const iotMain = read('cmd/iot-service/main.go');
...
const otaStore = read('modules/iot/internal/connectivity/edge_fleet_ota.go');
