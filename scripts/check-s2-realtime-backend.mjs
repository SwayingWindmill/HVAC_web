...
const [
  ...
  text('cmd/energy-api/internal/gateway/telemetry_test.go'),
  text('modules/telemetry/internal/telemetry/realtime.go'),
  text('modules/telemetry/internal/telemetry/centrifugo.go'),
  text('modules/telemetry/internal/telemetry/server.go'),
  text('modules/telemetry/internal/telemetry/realtime_postgres.go'),
  text('modules/telemetry/internal/telemetry/realtime_test.go'),
  text('modules/telemetry/internal/telemetry/realtime_postgres_integration_test.go'),
  text('scripts/run-s2-realtime-postgres-tests.mjs'),
  text('infra/telemetry/postgres/init/005-s2-realtime-backend.sql'),
  text('infra/telemetry/realtime/centrifugo.template.json'),
  text('infra/telemetry/realtime/compose.yaml'),
