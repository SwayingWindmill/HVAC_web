...
assert(manifestEntries.length === 63, `production migration allowlist must contain exactly 63 migrations, got ${manifestEntries.length}`);
...
assert(phase1Readme.includes('exact 63-file allowlist') && phase1Readme.includes('without runtime rewriting'), 'Phase 1 README must document the reviewed production-safe migration allowlist');
