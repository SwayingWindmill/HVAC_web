...
assert(manifestEntries.length === 52, `production migration allowlist must contain exactly 52 migrations, got ${manifestEntries.length}`);
...
assert(phase1Readme.includes('exact 52-file allowlist') && phase1Readme.includes('without runtime rewriting'), 'Phase 1 README must document the reviewed production-safe migration allowlist');
