...
assert(manifestEntries.length === 45, `production migration allowlist must contain exactly 45 migrations, got ${manifestEntries.length}`);
...
assert(phase1Readme.includes('exact 45-file allowlist'), 'Phase 1 README must document the production-safe migration allowlist');
