...
assert(manifestEntries.length === 51, `production migration allowlist must contain exactly 51 migrations, got ${manifestEntries.length}`);
...
assert(phase1Readme.includes('exact 51-file allowlist') && phase1Readme.includes('without runtime rewriting'), 'Phase 1 README must document the reviewed production-safe migration allowlist');
