...
export const SURFACE_CATALOG = [
  ...
  { id: '09', title: '告警', navLabel: '告警', group: 'events', scope: 'site', route: '/sites/:siteId/alarms', navigation: 'default', pattern: 'ledger' },
  { id: '10', title: '诊断', navLabel: '诊断', group: 'events', scope: 'site', route: '/sites/:siteId/diagnostics', navigation: 'default', pattern: 'ledger' },
  ...
  { id: '25', title: '控制', navLabel: '控制', group: 'optimization', scope: 'site', route: '/sites/:siteId/control', navigation: 'default', pattern: 'control' },
