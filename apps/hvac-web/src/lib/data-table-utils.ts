...
export function matchesSelectFilter<TData>(
  ...
  switch (filter.operator) {
    case 'eq':
    case 'inArray':
      return actual !== null && actual !== undefined && values.includes(actual);
    case 'ne':
    case 'notInArray':
      return actual === null || actual === undefined || !values.includes(actual);
    case 'isEmpty':
      return actual === null || actual === undefined || actual.length === 0;
    case 'isNotEmpty':
      return actual !== null && actual !== undefined && actual.length > 0;
    default:
      return false;
