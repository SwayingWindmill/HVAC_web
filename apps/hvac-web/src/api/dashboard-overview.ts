import { z } from 'zod';
import { createFrontendReviewDashboardOverview } from '@/app/frontend-review-overview-data';
...
export async function readDashboardOverview(siteId: string, signal?: AbortSignal): Promise<DashboardOverview> {
  if (__HVAC_WEB_FRONTEND_REVIEW__) return createFrontendReviewDashboardOverview(siteId);
